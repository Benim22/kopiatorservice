...
export default function BegFargkopiatorerA3() {
  ...
  useEffect(() => {
    async function fetchData() {
      setIsLoading(true);
      const fetchedProducts = await getProductsByCategory("beg-farg-a3");
      ...
      <section className="relative h-[40vh] min-h-[300px] flex items-center">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Begagnade Färgkopiatorer A3"
            fill
        ...
        <div className="container mx-auto px-4 z-10">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Begagnade Färgkopiatorer A3</h1>
          <p className="text-xl text-white/90 max-w-2xl">
            Kvalitetssäkrade begagnade A3-färgkopiatorer med garanti - ett ekonomiskt och miljömedvetet val.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-3">
              <h2 className="text-3xl font-bold text-[#003366] mb-6">Begagnade Färgkopiatorer A3</h2>
              <p className="text-gray-600 mb-8">
                Alla våra begagnade A3-färgkopiatorer genomgår en noggrann kvalitetskontroll och levereras med garanti.
                Ett smart val för dig som vill ha professionell kvalitet till ett förmånligt pris.
              </p>
              ...
              <div className="bg-[#F5F5F5] rounded-lg p-8 mb-8">
                <h3 className="text-xl font-bold text-[#003366] mb-4">Fördelar med våra begagnade A3-färgkopiatorer</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-500 mt-1 mr-3" />
                    <div>
                      <p className="font-medium text-gray-800">Miljömedvetet</p>
                      <p className="text-gray-600">Bidra till en hållbar framtid genom återanvändning.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="text-gray-600 mb-6">
                  Vill du veta mer om våra begagnade A3-färgkopiatorer eller boka en visning?
